...
const IngresantesAnioSede = ({cantidadSede,anioT}) => {
  ...
  return (
    <Grid container>
        ...
        <Grid item xs={12} md={12} sx={{mb:2}}>
           <Paper sx={{m:1,p:1, backgroundColor:'aliceblue'}}>
            <Typography variant='h5' sx={{textAlign:'center'}}>
              Año de Ingreso: {anioT} - Total de Ingresantes:{anioT>2018?total-cpnm-cpnf:total}
              </Typography>
            </Paper>
        </Grid>
     
     <Grid item xs={12} sm={12} md={6}>
     <Box sx={{textAlign:'center',border:1,m:1}}> <Typography variant='h6'>Ingreso por Genero</Typography></Box>
     ...
     <Grid item xs={12} sm={10} md={6}>
        <Box sx={{textAlign:'center',border:1,m:1}}> <Typography variant='h6'>Ingreso Tipo Ingreso</Typography></Box>
        <Paper sx={{display:'flex',p:1,m:1}} > 
     ...
     <Grid item xs={12} sm={10} md={6}>
        <Box sx={{textAlign:'center',border:1,m:1}}> <Typography variant='h6'>Ingreso Por carrera</Typography></Box>
        <Paper sx={{display:'flex',p:1,m:1}} > 
     ...
     <Grid item xs={12} sm={10} md={6}>
        <Box sx={{textAlign:'center',border:1,m:1}}> <Typography variant='h6'>Ingreso Por Sede</Typography></Box>
        <Paper sx={{display:'flex',p:1,m:1}} > 
