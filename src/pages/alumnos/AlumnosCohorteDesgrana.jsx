  ...
  return (
    ...
    <Container>
      ...
      <Grid item xs={12} md={12} bgcolor={'darkblue'} color={'white'}>
        <Typography variant='h6' textAlign={'center'}>Desgranamiento Cohorte por Sede Carrera </Typography>
      </Grid>
      ...
      <Box sx={{ display:'flex',border:1, borderRadius:2, backgroundColor:'beige',width:'100%', p:2 ,flexWrap:'wrap'}}>  
        ...
        <Box sx={{ display:'flex',border:1, borderRadius:2, backgroundColor:'beige',width:'100%', p:2, mt:1,mb:2}}>    

          <Grid item xs={12} md={6}>
      
              <Typography>Sede:{sede?traerSede(sede):'Mendoza'}, Carrera:{carrera?traerCarrera(carrera):'Contador Publico'}</Typography>
          </Grid>
          ...
          <Grid item xs={12} md={3}>
            <Typography>Ingresantes:{ingreAnio?ingreAnio[0].canti:0}</Typography>
          </Grid>
       </Box>
      
      

      {ingreAnio?ingreAnio[0].canti>0 ?alumnosDes?<>  
    
      <Grid item xs={12} md={4}>
            
              <Typography textAlign={'center'}>Datos Reinscripciones</Typography>
              <Table size='small'>
              <TableHead>
              <TableRow>
            ...
            {alumnosDes ? alumnosDes.map((ele,index) =>
                ...
                <TableRow key={index}>
                  ...
                  <TableCell>{Number(ele.total.reinsc/ingreAnio[0].canti * 100).toFixed(2)}</TableCell>
        ...
        <Grid item xs={12} md={7}>
                  ...
                  <Box sx={{width:'100%',height:'300px', mb:4}}>
                    {tgrafico==='1'
                      ...
                      ?alumnosDes? <LineChart datos={datos} etiquetas={labels} anioI={anioI} ingre={ingreAnio[0].canti} />:null
                      :alumnosDes? <BarCharts datos={datos} etiquetas={labels} anioI={anioI} ingre={ingreAnio[0].canti} />:null
        ...
        <Grid item xs={12} md={5}>
                <Paper elevation={3}>
                 <Table size='small'>
                  <TableRow>
                    <TableCell>Cohorte Nro de Ingresantes a una Carrera en un Año Lectivo</TableCell>
                  </TableRow>
                  <TableRow>
                      <TableCell>Tipo_ingreso 1(con título secundario), 3(mayor 25 años)</TableCell>
          ...
          <Grid item xs={12} md={5}>
                ...
                <Table size='small'>
                  <TableRow>
                    <TableCell>En la Tabla se muestra las reinscripciones en años Lectivos sucesivos</TableCell>
                  </TableRow>
                  <TableRow>  
                    <TableCell>El porcentaje es el nro de reinscriptos respectos a los ingresantes </TableCell>
                  </TableRow>
                </Table>
                </Paper>
          </Grid>
          ...
          <Typography variant='h6'>Aviso: Sin Datos de la Consulta</Typography>
          <Typography>Carrera no corresponde a la sede, CPN no vigente desde 2019, LNRG pudo no haber Inscripcion en ese año</Typography>
          <Typography>Sede Mendoza: todas las carreras excepto LNRG</Typography>
          <Typography>Sede Gral Alvear:solo LNRG</Typography>
          <Typography>Sede Este:LNRG y Logística</Typography>
          <Typography>Sede San Rafael: Solo dicta Contador Público</Typography>
          </Paper>
          </Grid>
          </>:null}
