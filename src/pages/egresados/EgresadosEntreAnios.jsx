  ...
  return (
    <>
              ...
              <Grid item xs={12} md={12}>
                <Box sx={{m:1, border:1, borderColor:'blue',backgroundColor:'#0000FF'}}>
                    <Typography variant='h5' color='white' sx={{textAlign:'center'}}> Egresos: En un Intervalo de Años Lectivos</Typography>
                </Box>
              </Grid>
              <Box sx={{ display:'flex',border:1, borderRadius:2, backgroundColor:'beige',width:'100%', p:2 ,flexWrap:'wrap'}}>
                    <Grid item xs={12} md={1} sx={{m:1}}>
